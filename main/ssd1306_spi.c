...
void spi_init(SSD1306_t * dev, int width, int height)
{
	...
	spi_master_write_command(dev, 0xA1);			
	spi_master_write_command(dev, 0xC8);			
	spi_master_write_command(dev, 0xA6);			
	spi_master_write_command(dev, 0xA8);			
	spi_master_write_command(dev, 0x3f);			
	spi_master_write_command(dev, 0x00);			
	spi_master_write_command(dev, 0xd5);			
	spi_master_write_command(dev, 0x80);			
	spi_master_write_command(dev, 0xD9);			
	spi_master_write_command(dev, 0xF1);			
	spi_master_write_command(dev, 0xDA);			
	spi_master_write_command(dev, 0x12);			
	spi_master_write_command(dev, 0xDB);			
	spi_master_write_command(dev, 0x40);			
	...
	spi_master_write_command(dev, 0xA4);			
	spi_master_write_command(dev, 0xA6);			
	spi_master_write_command(dev, 0xAF);			
	spi_master_write_command(dev, 0xAF);			
	ESP_LOGI(TAG, "CYPTEST 0001");
